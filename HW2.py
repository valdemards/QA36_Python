...
result_subtr = item_1 - item_2 if (item_1 > item_2) else item_2 - item_1
...
result_s_root = random.choice([item_1, item_2]) ** 0.5
...
result_m_s_root = math.sqrt(random.choice([item_1, item_2]))
...
result_mp_s_root = math.pow(random.choice([item_1, item_2]), 0.5)
